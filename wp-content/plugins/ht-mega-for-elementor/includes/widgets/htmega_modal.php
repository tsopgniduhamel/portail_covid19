                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .htmega-modal-btn button svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' =>[
                                'button_icon_type' =>'icon',
                                'button_icon[value]!' =>'',
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .htb-modal-footer h5',
                    'separator' => 'before',
                ]
            );
        ...
        ?>
            ...
            <div class="htmega-modal-btn">
                <?php
                    ...
                    echo sprintf('<button type="button" data-toggle="htbmodal" data-target="#htmegamodal%1$s">%2$s</button>', $id, $buttontxt );
                ?>
            </div>
                        ...
                        <div class="htb-modal-footer">
                            <?php
                                ...
                                if( !empty( $settings['footer_close_txt'] ) ){
                                    echo '<button type="button" class="htb-btn htb-btn-secondary" data-dismiss="modal">'.esc_html__($settings['footer_close_txt'],'htmega-addons').'</button>';
                                }
                            ?>
                        </div>
