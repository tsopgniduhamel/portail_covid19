                    ...
                    <div class="content">
                        <?php
                            if( !empty( $settings['event_title'] ) ){
                                echo '<h4><a href="#">'.esc_html__( $settings['event_title'],'htmega-addons').'</a></h4>';
                            }
                        ...
                        <?php 
                            ...
                            if( !empty( $settings['event_description'] ) ){
                                echo '<p>'.esc_html__( $settings['event_description'], 'htmega-addons' ).'</p>';
                            }
                        ?>
                        <?php if( !empty( $settings['event_button'] ) ):?>
                            <div class="event-btn">
                                <a <?php echo $this->get_render_attribute_string( 'url' ); ?> > <?php esc_html_e( $settings['event_button'], 'htmega-addons' ); ?></a>
                            </div>
                        <?php endif;?>
                    </div>
                </div>
