            ...
            <div <?php echo $this->get_render_attribute_string( 'htmega_banner' ); ?>>
                ...
                <?php
                    if( !empty($settings['banner_badge_image']['url']) ){
                        echo '<div class="htbanner-badgeimage"><img src="' . $settings['banner_badge_image']['url'] . '"></div>';
                    }
                ?>
                <div class="banner-content">
                    <?php
                        ...
                        if( !empty( $settings['banner_button_txt'] ) ){
                            echo '<a '.$this->get_render_attribute_string( 'url' ).'>'.esc_html__( $settings['banner_button_txt'],'htmega-addons' ).'</a>';
                        }
                    ?>
                </div>
            </div>
